...
func NewNonFungibleTokenData(attr *MintNonFungibleTokenAttributes, txHash []byte, currentBlockNr uint64) types.UnitData {
...
func NewFungibleTokenData(attr *MintFungibleTokenAttributes, txHash []byte, currentBlockNr uint64) types.UnitData {
